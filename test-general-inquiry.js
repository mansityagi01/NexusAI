// Test script for general inquiry
...
socket.on('connect', () => {
  ...
  // Test creating a general inquiry ticket
  socket.emit('create_ticket', { 
    ticket_subject: 'How do I reset my password for the company portal?' 
  });
  
  console.log('📧 General inquiry ticket created');
});
